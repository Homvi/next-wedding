            ...
            <div className="flex custom-border w-[90%] justify-center">
                ...
                <form className='justify-around items-start text-white luthier-regular  flex w-[50%] flex-col' data-netlify="true" name="visszajelzesek" action="/success" method="POST">
                    ...
                    <p className='flex justify-start  flex-col pl-5 w-[90%]' >
                        ...
                        <input className='border-4 border-[#ffbd59]/80 px-2  rounded-xl bg-transparent' type="text" name="tud jönni?" id="canCome" />
                    </p>
                    ...
                    <p className='flex justify-start flex-col pl-5 w-[90%]' >
                        ...
                        <input className='border-4 border-[#ffbd59]/80 px-2  rounded-xl bg-transparent' type="text" placeholder="fő, név..." name="Hanyan jottok?" id="howManyPerson" />
                    </p>
                    <p className='flex justify-start flex-col pl-5 w-[90%]' >
                        <label htmlFor="foodIntolerance" className='text-left  pb-2' >
                            Írd meg, hogy van e ételérzékenységed.
                        </label>
                        <input className='border-4 border-[#ffbd59]/80 px-2  rounded-xl bg-transparent' name="etel erzekenyseg" id="foodIntolerance"></input>
                    </p>
