...
const OurStory = () => {
    return (
        <section className=' py-3 min-h-screen  items-center  text-center flex flex-col' >
            <h1 className='luthier-bold text-3xl  text-center text-[#fdfbf7] mt-10 uppercase' >A mi kis<br/> történetünk...</h1>
            <div className="flex w-screen xl:w-[90%] custom-border justify-around p-5 items-center ">
                ...
                <div className="text-[#fdfbf7] flex tracking-wider leading-7 xl:leading-10 text-2xl items-center text-center md:h-[90vh] md:w-[50%] md:py-5 my-5 luthier-bold-italic">
