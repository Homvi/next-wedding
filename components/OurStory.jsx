    ...
    return (
        <section className=' py-3 min-h-screen w-[95vw] items-center  text-center flex flex-col' >
            ...
            <div className="flex  w-[100%] custom-border justify-around p-5 items-center ">
                ...
                <div className="text-[#fdfbf7] flex tracking-wider leading-7 xl:leading-10 text-2xl items-center text-center md:h-[90vh] md:w-[60%] md:py-5 my-5 luthier-bold-italic">
