...
const OurStory = () => {
    return (
        <section className=' my-5 border-b-4 border-[#ffbd59] md:border-[#faf8ebc3] min-h-screen w-[95vw] items-center  text-center flex flex-col' >
            ...
            <div className="flex  w-[100%] justify-around p-5 items-center ">
                ...
                <div className="flex tracking-wider md:tracking-widest leading-10 text-2xl items-center text-center md:h-[90vh] md:w-[60%] md:py-5 my-5 luthier-bold-italic">
