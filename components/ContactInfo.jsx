...
const ContactInfo = () => {
    return (
        <section className=' py-3  min-h-[50vh] items-center  text-[#fff] text-center flex flex-col' >
            <h1 className='text-2xl mt-3 mb-10 uppercase luthier-bold' >Elérhetőségek</h1>
            <div className="flex flex-col md:flex-row justify-around w-[90%] custom-border pb-10">
