...
const OurLove = () => {
    return (
        <section className=' py-3 max-h-screen border-b-4 border-[#ffbd59] md:border-[#faf8ebc3] items-center w-[95vw] text-center flex flex-col' >
            <div className="flex w-[100%]  p-5 xl:p-5 items-center">
                <div className="flex tracking-wider md:tracking-widest leading-10 text-2xl items-center text-center md:h-[90vh] md:w-[60%] p-1 md:p-10  luthier-bold-italic">
